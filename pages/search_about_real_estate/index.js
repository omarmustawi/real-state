      ...
      <section className="background1 top-28 relative flex justify-center items-center flex-col text-slate-700">
        ...
        >
          ...
          >
            ...
            />
            <button className="w-28 m-auto text-lg  p-2 bg-slate-400 text-white rounded-xl border-2 border-transparent hover:border-2 hover:border-slate-400 hover:bg-white hover:text-slate-400">
              ابحث
            </button>
          </form>
        </div>
